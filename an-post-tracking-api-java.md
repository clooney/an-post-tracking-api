An Post Tracking API - Java
================================
Use Java to track An Post shipments with An Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.anpost;
    ...
    public class CreateAnPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("CP730500199GB");
                createTrackingParams.setCourierCode("an-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    package com.trackingmore.example.an-post;
    ...
    public class CreateAn PostTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RF054985422GB");
                createTrackingParams1.setCourierCode("an-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("LO366992772GB");
                createTrackingParams2.setCourierCode("an-post");
...
Get status of the shipment:
    ...
    public class GetAnPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RF054985422GB,LO366992772GB");
                trackingParams.setCourierCode("an-post");
...
Update a tracking by ID:
    ...
    public class UpdateAnPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9bcffe4c7caf66b47430d8e262518152";
