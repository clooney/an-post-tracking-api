An Post Tracking API - .Net
================================
Use .Net to track An Post shipments with An Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "CP730500199GB";
                  createTrackingParams.courierCode = "an-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "RF054985422GB,LO366992772GB";
                  getTrackingResultsParams.courierCode = "an-post";
